import { NgElementStrategyFactory, NgElementStrategy, NgElementStrategyEvent } from '@angular/elements';
import { ComponentFactory, Type, Injector, ComponentFactoryResolver,
  ComponentRef, SimpleChanges, OnChanges, ApplicationRef, EventEmitter, SimpleChange } from '@angular/core';
 ...
 * @publicApi
 */
export class XComponentNgElementStrategyFactory implements NgElementStrategyFactory {
